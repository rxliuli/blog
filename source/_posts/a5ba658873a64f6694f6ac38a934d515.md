...
categories:
  ...
  - Browser Extension
date: 1769006025468
updated: 1769652955651
---

## 前言

在上一章 [Browser Extension Dev - 06. Inject Script on Demand](/p/94e908bbc67f4eacaee1e6e9d38c4d41) 中，我们介绍了按需为网页注入脚本执行自定义的功能，还实现了一个简单的复制网页主要内容为 Markdown 的扩展。在这一章中，我们将继续实现一个 Popup 弹窗，用于显示页面主要内容转换得到的 Markdown，并支持在复制之前进行预览和编辑。
