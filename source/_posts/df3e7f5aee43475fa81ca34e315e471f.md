---
layout: post
title: "JavaScript 自定义限流队列 fetch\r"
abbrlink: df3e7f5aee43475fa81ca34e315e471f
date: 2020-02-02 10:15:37
updated: 2020-12-30 12:52:17
tags:
  - javascript
  - 异步
sticky: null
...
1.  在请求前判断当前请求的数量，添加请求等待数量
    1.  如果请求数量已满，则进行等待
    1.  如果请求数量未满，则删除一个请求等待数量
1.  请求完成，删除当前请求数量
...
1.  使用 class 定义默认超时设置和请求数量限制的构造函数
1.  在请求前将请求 argments 添加到等待队列中
1.  使用 `setInterval` 函数持续监听队列和当前执行的请求数
