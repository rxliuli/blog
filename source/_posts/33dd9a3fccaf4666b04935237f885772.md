...
现在，像 [基本项目搭建](/p/23ec4673a06f41b59bfaf5a7da6d98db) 中 **更新 _package.json_ 添加几个 npm script** 说的那样启动开发环境就会显示开发环境的页面，打包后显示的则是打包后的静态资源。

![效果](/resource/866c4124afe04289b88972507b3f6743.png)
