...
![强制换行](https://img.rxliuli.com/20191212090747.png)
...
![根据源代码自动滚动项目设置](https://img.rxliuli.com/20191224100414.png)

2019.3 之前

在 _Project ⇒ Tool ⇒ Autoscroll from Source_ 中可以找到这个配置，启用即在整个项目中启用了。

![根据源代码自动滚动项目设置](https://img.rxliuli.com/20191212090627.png)
