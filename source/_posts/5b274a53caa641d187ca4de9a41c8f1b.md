...
我之前写过两篇关于 Safari 扩展的博客：[如何把 Chrome 扩展转换为 Safari 扩展](https://rxliuli.com/blog/convert-chrome-extension-to-safari/)，以及[如何发布到 iOS App Store](https://rxliuli.com/blog/publishing-safari-extensions-to-the-ios-app-store/)。它们解决的是"第一次怎么做成"。但随着我的 Safari 扩展越来越多，每次发版的手动流程变得越来越难以忍受：打开 Xcode、改版本号、Archive、Validate、Distribute，再打开 App Store Connect 选 bundle、填 release note、点提交——每个扩展半小时起步，而且不能出错。
