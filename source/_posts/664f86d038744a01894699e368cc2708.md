...
- [前端资源管理](#前端资源管理)
  ...
  - [小型工具库](#小型工具库)
    ...
    - [glob-promise: glob promise 封装](#glob-promise-glob-promise-封装)
...
### [glob-promise](https://www.npmjs.com/package/glob-promise): glob promise 封装

相比于 globby 不顾兼容性仅支持 esm，glob 则支持 cjs 模块，而 glob-promise 仅仅是添加了回调。
