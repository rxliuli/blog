---
layout: post
title: "Vue 实现一个简单的瀑布流组件\r"
abbrlink: 9d0ebb24fd1941e6b61c3714e0aa2896
date: 2020-02-02 10:15:37
updated: 2020-12-30 08:21:59
tags:
  - vue
sticky: null
---
...
1.  定义一个 vuejs 容器组件
1.  抽离出公共的属性（加载一页数据的函数/每个元素的模板）
1.  在父容器中遍历每个元素并绑定到传入的模板上
1.  监听滚动事件，如果不是最后一页就加载下一页
1.  重新渲染集合元素
