...
abbrlink: 451a27c2435349988383f7ca2ace8e83
date: 2020-04-18 10:14:09
updated: 2020-12-30 01:10:52
tags:
  - java
sticky: null
---
...
1.  定义每个字段的操作类 `BeanCopyField`，保存对每个字段的操作
1.  定义 `BeanCopyConfig`，用于配置拷贝属性的策略
1.  定义 `BeanCopyOperator` 作为拷贝的真正实现
